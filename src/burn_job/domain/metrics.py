...
class MetricSource(str, Enum):
    ...
    STATIC_JAVAP = "STATIC_JAVAP"
    DYNAMIC_ASYNC_PROFILER = "DYNAMIC_ASYNC_PROFILER"
    DYNAMIC_JFR = "DYNAMIC_JFR"

@dataclass(frozen=True)
class Metric:
    """Represents a measured metric point."""
    name: str
    value: float
    unit: str
    source: MetricSource = MetricSource.STATIC_AST
