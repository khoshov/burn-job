...
### Этап 2: Генерация нагрузочного теста
...
### Этап 5: Детекция дефектов (T1–T9) — **центральный этап**
